...
<body>
    ...
    <div class="information">
        ...
        <div class="contact-info">
            ...
            <div class="item">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    class="bi bi-whatsapp icon" viewBox="0 0 16 16">
                    <path
            ...
            <div class="item">
                ...
                <a href="mailto:discipuladoievv@verbodavida.com" style="text-decoration: none; color: inherit;">
                    <p>discipuladoievv@verbodavida.com</p>
                </a>
            </div>
        </div>
    </div>
